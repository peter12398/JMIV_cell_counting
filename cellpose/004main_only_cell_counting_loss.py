...
class Dataset:
    ...
    def __getitem__(self, i):
        ...
        if not image_name in self.imCol_cache_dict.keys():
            ...
            imColLarge = cv2.cvtColor(imColLarge, cv2.COLOR_BGR2RGB) 
...
class H_maxima_model:
    ...
    def test(self, test_set):      
        ...
        for i in ids:
            ...
            plt.imsave(save_path+"/{}_imDetecCol_{}_prh{}.png".format(imname,ndetec,pr_h), imDetecCol)
        ...
        print("ARE =:", np.average(average_relative_error_list))
